  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (match) {
        ...
        setErrorMsg('Autentikasi Gagal: Kombinasi username atau password salah untuk PT. Presitama Service Industry.');
      }
      setIsSubmitting(false);
    }, 800);
  };
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-slate-900 text-slate-100 font-sans relative overflow-hidden">
      ...
      <header className="px-6 py-4 flex items-center justify-between border-b border-slate-800 bg-slate-950/40 relative z-10 shrink-0">
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-blue-600 shadow-md">
            <span className="text-sm font-black text-white">PSI</span>
          </div>
          <div>
            <h1 className="text-sm font-black tracking-wider text-white">PT. PRESITAMA SERVICE INDUSTRY</h1>
            <p className="text-[10px] text-slate-400 font-bold tracking-tight">Kawasan Industri MM2100, Cibitung - Indonesia</p>
          </div>
        </div>
      ...
      <div className="flex-1 max-w-5xl w-full mx-auto px-4 py-8 md:py-16 grid grid-cols-1 md:grid-cols-12 gap-8 items-center relative z-10 overflow-y-auto">
        ...
        <div className="md:col-span-5 space-y-6 text-left">
          ...
          <p className="text-xs text-slate-400 font-medium leading-relaxed">
            Selamat datang di portal autentikasi terpusat karyawan PT. Presitama Service Industry. Hubungi bagian IT Support apabila terjadi kendala akses login sistem atau sinkronisasi Supabase.
          </p>
        ...
        <div className="md:col-span-7 space-y-5">
          <div className="bg-slate-950/60 backdrop-blur-md rounded-2xl border border-slate-800 p-6 md:p-8 shadow-2xl relative">
            ...
            <p className="text-[11px] text-slate-400 mb-6 font-medium font-sans">Gunakan kredensial portal resmi karyawan PT. Presitama Service Industry.</p>
            ...
            <form onSubmit={handleFormSubmit} className="space-y-4">
              ...
              >
                {isSubmitting ? 'Mengautentikasi...' : 'Masuk Portal Secure PSI'}
                <ArrowRight size={14} />
              </button>
            </form>
      ...
      <footer className="px-6 py-4 border-t border-slate-800 bg-slate-950 text-slate-500 text-center text-[10px] font-bold relative z-10 shrink-0">
        <p>© 2026 PT. Presitama Service Industry ERP & Supply Chain Portal. All rights reserved.</p>
      </footer>
    </div>
  );
}
